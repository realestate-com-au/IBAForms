...
@property (nonatomic, strong) id<IBAInputRequestorDataSource> inputRequestorDataSource;
@property (nonatomic, strong) IBAInputNavigationToolbar *inputNavigationToolbar;
