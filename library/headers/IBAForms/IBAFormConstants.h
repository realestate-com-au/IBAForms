...
#define IBAFormFieldActiveBackgroundColor [UIColor colorWithRed:0.893 green:0.976 blue:0.976 alpha:1.000]
#define IBAFormFieldBackgroundColor [UIColor whiteColor]
